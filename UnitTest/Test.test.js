...
describe("Get Post by ID API Test", () => {
  ...
  it("should fetch a post by ID", async () => {
    const authorizationHeader = 'Bearer blogAPI';
    const res = await chai.request(app).get("/api/posts/8900").set('Authorization', authorizationHeader);
...
describe("Delete Post by ID API Test", () => {
  ...
  it("should delete a post by ID", async () => {
    const authorizationHeader = 'Bearer blogAPI';
    const res = await chai.request(app).delete("/api/posts/8900").set('Authorization', authorizationHeader);;
